      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col gap-8 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">Luxor-A est une plateforme numérique de mise en relation entre particuliers permettant la location d'articles de toute nature (mode, véhicules, immobilier, électronique, loisirs, etc.). La plateforme est éditée et exploitée par Luxor-A (ci-après "Luxor-A", "la Plateforme", "nous").</p>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">2. Rôle de Luxor-A — Intermédiaire technique</h2>
            <p className="mb-3">Luxor-A agit exclusivement en tant qu'intermédiaire technique de mise en relation. À ce titre :</p>
            <ul className="list-disc pl-5 space-y-2">
              <li>Luxor-A n'est ni loueur ni locataire dans les transactions réalisées entre utilisateurs.</li>
              <li>Luxor-A ne prend aucune part aux contrats conclus entre Loueurs et Locataires.</li>
              <li>Luxor-A ne garantit pas la qualité, la conformité, la légalité ou la disponibilité des articles proposés à la location.</li>
              <li>Luxor-A ne garantit pas la solvabilité, la bonne foi ou le sérieux des utilisateurs inscrits sur la Plateforme.</li>
              <li>Luxor-A se réserve le droit de suspendre ou supprimer tout compte ou toute annonce ne respectant pas les présentes CGU, sans préavis ni indemnisation.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">Luxor-A se réserve le droit de refuser l'inscription ou de suspendre tout compte à sa seule discrétion.</p>
          </section>

          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">4. Publication d'annonces</h2>
            <p className="mb-3">Tout Loueur publiant une annonce sur Luxor-A s'engage à :</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <p className="mt-3">Luxor-A se réserve le droit de supprimer toute annonce ne respectant pas ces conditions, sans obligation de justification.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Les frais de service Luxor-A (12% TTC).</li>
              <li>La caution éventuelle fixée par le Loueur.</li>
              <li>Le montant total à régler.</li>
            </ul>
            <p className="mt-3">Les frais de service rémunèrent les services fournis par Luxor-A, notamment la mise en relation, la messagerie sécurisée, la génération automatique de contrats de location et la maintenance de la Plateforme. Ces frais ne sont pas remboursables sauf en cas de manquement avéré de la part de Luxor-A.</p>
          </section>

          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">6. Réservations et contrat de location</h2>
            <p className="mb-3">Toute réservation effectuée via Luxor-A génère automatiquement un contrat de location entre le Loueur et le Locataire. Ce contrat est téléchargeable au format PDF et constitue le seul engagement contractuel entre les parties. Luxor-A n'est pas partie à ce contrat.</p>
            ...
            <p>En cas d'annulation par le Locataire dans les 24 heures suivant la réservation, les frais de service Luxor-A pourront être retenus à hauteur de 50% du montant réglé.</p>
          </section>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">8. Limitation de responsabilité de Luxor-A</h2>
            <p className="mb-3">Dans toute la mesure permise par la loi applicable, Luxor-A décline expressément toute responsabilité concernant :</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <p className="mt-3">En cas de litige entre utilisateurs, Luxor-A n'intervient pas en tant qu'arbitre ou médiateur et ne peut être tenu responsable de l'issue d'un tel litige.</p>
          </section>

          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">9. Contenus interdits</h2>
            <p className="mb-3">Il est strictement interdit de publier ou proposer à la location sur Luxor-A :</p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            ...
            <p>L'ensemble des éléments constituant la Plateforme (design, logo, textes, fonctionnalités) sont la propriété exclusive de Luxor-A et sont protégés par les lois relatives à la propriété intellectuelle. Toute reproduction, représentation ou utilisation sans autorisation expresse est interdite.</p>
          </section>

          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">11. Protection des données personnelles</h2>
            <p className="mb-3">Luxor-A collecte et traite les données personnelles des utilisateurs dans le respect du Règlement Général sur la Protection des Données (RGPD). Les données collectées sont les suivantes :</p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            ...
            <p>En créant un compte et en utilisant Luxor-A, l'utilisateur reconnaît avoir lu, compris et accepté sans réserve l'intégralité des présentes Conditions Générales d'Utilisation. L'utilisation de la Plateforme vaut acceptation inconditionnelle de ces conditions.</p>
          </section>

        </div>

        <div className="mt-10 pt-6 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400">Luxor-A — Plateforme de location entre particuliers</p>
          <p className="text-xs text-gray-300 mt-1">Pour toute question : contact@Luxor-A.app</p>
        </div>
